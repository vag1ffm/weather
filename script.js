function hide() {
    document.querySelector('.first-infa').style.display = 'none'
    document.querySelector('.second-infa').style.display = 'none'
    document.querySelector('.third-infa').style.display = 'none'
...
function forlocalstor() {
    for (let i = 0; i<localStorage.length ;i++) {
        ...
        let place = document.querySelector('.added-city>ul')
        let liEliment = value;
        place.innerHTML += `<li onclick="FastShow('${liEliment}')">${value}</li>`
